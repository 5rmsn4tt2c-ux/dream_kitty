...
run(function()
	...
	if not canDebug then
		local cheatenginelib = loadstring(downloadFile('dream_kitty/libraries/cheatenginelib.lua'), 'cheatenginelib')(vape, vapeEvents, entitylib)
		require = function(v) 
...
run(function()
	...
	local packages = httpService:JSONDecode(downloadFile('dream_kitty/profiles/packages.json'))	
...
run(function()
    ...
    vape.Components.HotbarList = function(optionsettings, children, api)
        ...
        textbuttonicon.Image = getcustomasset('dream_kitty/assets/new/add.png')
            ...
            local mounted = bedwars.Roact.mount(create('BillboardGui', {
                ...
                create('Frame', {
                    ...
                    create('ImageLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Image = getcustomasset('dream_kitty/assets/new/blur.png'),
