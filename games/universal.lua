...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('dream_kitty/assets/new/blur.png')
...
vape.Libraries.string = loadstring(downloadFile('dream_kitty/libraries/string.lua'), 'string')()
...
local hash = loadstring(downloadFile('dream_kitty/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('dream_kitty/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('dream_kitty/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:announce(text)
		...
		icon.Image = getcustomasset('dream_kitty/assets/new/vape.png')
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('dream_kitty/profiles/whitelist.json') and readfile('dream_kitty/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('dream_kitty/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('dream_kitty/assets/new/radaricon.png'),
...
run(function()
    ...
    local function Added(ent)
    	...
    	arrow.Visible = false
    	arrow.Image = getcustomasset('dream_kitty/assets/new/arrowmodule.png')
